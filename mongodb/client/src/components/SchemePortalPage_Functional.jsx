...
const SchemePortalPage = () => {
  ...
  const viewSchemeDetails = useCallback((schemeId) => {
            ...
            <div className="stat-card">
              ...
              <div className="stat-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <g dangerouslySetInnerHTML={{ __html: getIconPath(stat.icon) }} />
                </svg>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center gap-2">
                ...
                {report.status === "Available" && (
                  <button 
                    ...
                    onClick={() => viewReport(report.season)}
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              >
                <div className="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <g dangerouslySetInnerHTML={{ __html: getIconPath(option.icon) }} />
                  </svg>
